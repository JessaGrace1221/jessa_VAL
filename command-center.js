...
window.openTranscriptChat=function(question){
  ...
  var el=document.createElement('div');el.id='valTranscriptChatOverlay';el.className='gchat-overlay val-transcript-chat-overlay';
