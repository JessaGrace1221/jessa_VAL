...
| Project Managers drawer/card | `.project-drawer-link` | `project_packet` index state | Project understanding prompt suite | Project source, linked people/docs/reviews | Open full Project Manager page, create/review project candidate | Do not create project records without explicit create flow | Project Managers index opens |
