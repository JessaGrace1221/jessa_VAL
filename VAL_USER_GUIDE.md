...
VAL Home is the executive environment. It restores the current day, relationship context, commitments, prepared drafts, and review gates before asking you to act.
...
- start focused Co-Work with VAL
- jump into Co-Work, meeting mode, posting review, or document creation
...
- VAL Home: returns to the main executive environment
...
Saved Co-Work conversations can be reloaded from recent threads and searched later as memory.
