...
test('production shell fingerprints the mobile operating contract', () => {
  assert.match(html, /hearth-prototype\.css\?v=environment-action-item-trigger-20260804/);
  assert.match(html, /hearth-prototype\.js\?v=environment-action-item-trigger-20260804/);
});
