...
test('production shell fingerprints the mobile operating contract', () => {
  assert.match(html, /hearth-prototype\.css\?v=val-studio-transcript-email-20260804/);
  assert.match(html, /hearth-prototype\.js\?v=val-studio-transcript-email-20260804/);
});
