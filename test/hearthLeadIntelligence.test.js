...
test('Executive Inbox drawer opens prepared replies inside the Hearth', () => {
  ...
  assert.match(hearthJs, /drawerUtilityAction = \['show_rules', 'save_forward_rule', 'save_safe_contact', 'suggest_rules'\]\.includes\(correspondenceActionId\)/);
  ...
  assert.match(hearthJs, /inspectOnlyAction = \['cowork_correspondence', 'resolve_thread', 'safe_contact', 'not_executive_contact', 'show_rules', 'save_forward_rule', 'save_safe_contact', 'suggest_rules'\]\.includes\(correspondenceActionId\)/);
