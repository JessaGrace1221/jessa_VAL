...
test('Executive Inbox drawer opens prepared replies inside the Hearth', () => {
  ...
  assert.match(hearthJs, /return \['send', 'cowork_correspondence', 'not_executive_contact', 'save_forward_rule', 'suggest_rules'\]/);
  ...
  assert.match(hearthJs, /\/api\/email\/automation-rule/);
