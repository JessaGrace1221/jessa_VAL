...
test('Hearth calendar prep is connected to the meeting prep backend contract', () => {
  ...
  assert.match(hearthJs, /This Meeting Prep packet is temporary and read-only/);
  assert.match(hearthJs, /Do not write back to Relationships, Projects, transcripts, tasks, drafts, or other drawers/);
  assert.match(hearthJs, /Use the May 26 Meeting Mode style/);
  assert.match(hearthJs, /Attendee intelligence:/);
  assert.match(hearthJs, /Saved memory \/ transcripts \/ recent changes:/);
  assert.match(hearthJs, /Related tasks \/ open loops \/ likely follow-up:/);
  assert.match(hearthJs, /If public evidence is verified, say "This is what I found on the web about \[Name\]"/);
  assert.match(hearthJs, /This is what I found on the web about \[Name\]/);
  ...
  assert.match(hearthJs, /What I should know about each attendee/);
  assert.match(hearthJs, /Risks or flags/);
  assert.match(hearthJs, /Likely follow-up/);
  ...
  assert.match(hearthJs, /VAL is holding the Meeting Prep packet privately/);
