...
test('Executive Inbox drawer opens prepared replies inside the Hearth', () => {
  ...
  assert.match(hearthJs, /Checking Gmail and relationship history/);
  ...
  assert.match(hearthJs, /\/api\/projects\/create/);
  assert.match(hearthJs, /const ruleActions = \['show_rules', 'search_inbox', 'save_forward_rule', 'save_safe_contact', 'suggest_rules'\]/);
  assert.match(hearthJs, /drawerUtilityAction = \['show_rules', 'search_inbox', 'save_forward_rule', 'save_safe_contact', 'suggest_rules'\]\.includes\(correspondenceActionId\)/);
  ...
  assert.match(hearthJs, /inspectOnlyAction = \['cowork_correspondence', 'generate', 'forward', 'resolve_thread', 'safe_contact', 'not_executive_contact', 'link_relationship', 'create_relationship', 'link_project', 'create_project', 'show_rules', 'search_inbox', 'save_forward_rule', 'save_safe_contact', 'suggest_rules'\]\.includes\(correspondenceActionId\)/);
