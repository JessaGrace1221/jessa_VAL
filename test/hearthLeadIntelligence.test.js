...
test('Hearth text inputs offer VAL autocorrect suggestions without silently rewriting', () => {
  ...
  assert.match(hearthHtml, /hearth-prototype\.css\?v=frosted-open-surfaces-20260708/);
  assert.match(hearthHtml, /hearth-prototype\.js\?v=frosted-open-surfaces-20260708/);
});
