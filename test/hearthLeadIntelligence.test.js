...
test('Executive Inbox drawer opens prepared replies inside the Hearth', () => {
  ...
  assert.match(hearthJs, /inspectOnlyAction = \['cowork_correspondence', 'resolve_thread', 'not_executive_contact', 'show_rules', 'save_forward_rule', 'suggest_rules'\]\.includes\(correspondenceActionId\)/);
