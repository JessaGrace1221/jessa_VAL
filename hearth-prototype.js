...
const hearthClickContractRegistry = [
  ...
  {selector:'.workspace-card button,.workspace-actions button', contract:'workspace.static_action', packet:'workspace_seed_packet', rule:'Static workspace action rule', actions:'Open the matching review/approval/teaching workspace only', never:'Do not execute external action from static demo card'},
